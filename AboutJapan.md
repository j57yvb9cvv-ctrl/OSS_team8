...
- 일본은 예의를 매우 중요하게 여긴다.
- 인사할 때 고개를 숙이는 ‘오지기(お辞儀)’ 문화가 있다.(상황에 따라 각도와 의미가 다르다)
- 존댓말(경어)을 상황에 맞게 사용한다.
- 상황에 따라 인사 방법이 다르다. 친구 사이에서는 반말을 사용하고 '오지기'를 거의 안 하거나 가볍게 하며 편하고 자연스러운 표현을 쓴다. 비즈니스 상황에서는 존댓말을 사용하며 '오지기'를 함께 사용하며 정중하고 격식 있는 표현을 쓴다.
...
- 대중교통 이용 시 통화나 큰 소리를 자제하는 문화가 있다. 
